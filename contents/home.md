...
张书豪，华中科技大学计算机科学与技术学院教授（[个人主页](http://faculty.hust.edu.cn/ZHANG_SHUHAO/zh_CN/index.htm)）。研究聚焦 **复杂硬件与动态负载下的高效状态管理**，重点关注并行分布式系统，并进一步延伸至 **大模型推理基础设施**，尤其是推理服务中的访问调度、执行优化与状态复用问题。加入 HUST 前，曾于新加坡南洋理工大学（NTU）任助理教授（[ORCID](https://orcid.org/0000-0002-9927-6925)），并在德国柏林工业大学（TUB）从事博士后研究。

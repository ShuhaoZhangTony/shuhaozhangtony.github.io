张书豪，现任华中科技大学（HUST）计算机科学与技术学院教授、博导。此前，他在新加坡南洋理工大学（NTU）担任[助理教授](https://dr.ntu.edu.sg/cris/rp/rp02324/)，专注于流数据处理系统、数据库系统和高性能计算领域的研究。在德国柏林技术大学（TUB）进行博士后研究期间，他与多个国际团队合作，推动了数据管理和流计算的前沿技术。
